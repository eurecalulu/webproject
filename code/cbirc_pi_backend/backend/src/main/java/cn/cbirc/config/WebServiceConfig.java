...
public class WebServiceConfig {
    ...
    @Autowired
    private PolicyInterpretationWebService policyInterpretationService;
    ...
    public Endpoint endpoint() {
        EndpointImpl endpoint = new EndpointImpl(springBus(), policyInterpretationService);
