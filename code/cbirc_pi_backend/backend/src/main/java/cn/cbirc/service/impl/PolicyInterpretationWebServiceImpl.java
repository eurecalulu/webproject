...
import cn.cbirc.service.PolicyInterpretationWebService;
 ...
 */
@Component
@WebService(name = "PolicyInterpretationWebServiceImpl", targetNamespace = "http://webservice.cbirc.cn",
        endpointInterface = "cn.cbirc.service.PolicyInterpretationWebService")
public class PolicyInterpretationWebServiceImpl implements PolicyInterpretationWebService {
    @Autowired
    ...
    @Override
    public PolicyInterpretationVO getById(int id) {
        return new PolicyInterpretationVO(piRepository.getById(id));
    }

    @Override
    public List<PolicyInterpretationVO> list(boolean withBody, String docTitle, String docId, String docDepart, String startTime, String endTime, int pageNo, int pageSize) {
        ...
        PageList<PolicyInterpretationVO> piPageList =  piService.listPublicByFilter(filter);
        return piPageList.getData();
    }

    @Override
    public int count(String docTitle, String docId, String docDepart, String startTime, String endTime) {
        ListPolicyInterpretFilter filter = new ListPolicyInterpretFilter()
                .setDocTitle(docTitle)
                .setDocIdentifier(docId)
                .setDocDepart(docDepart)
